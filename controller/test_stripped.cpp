...
namespace Game {
    constexpr DWORD GM_PTR=0x00D387AC, GM_OFFSET=0x14, LP_OFFSET=0x40, ENTITY_TREE=0x3C;
    ...
    constexpr DWORD ENT_HP=0x10C, ENT_MAX_HP=0x110, ENT_MANA=0x114, ENT_MAX_MANA=0x118;
    constexpr DWORD ENT_LEVEL=0x2E0, ENT_CLASS_IND=0x3ED;
    constexpr DWORD VT_PLAYER=0x00C80F9C, VT_BEAST=0x00C81490, VT_CORPSE=0x00C4FC5C;
    constexpr DWORD OBJ_OBJECT_ID=0x120, OBJ_TYPE_ID=0x124;
    constexpr DWORD CURSOR_OFFSET=0x123C, CUR_X=0x08, CUR_Y=0x0A;
